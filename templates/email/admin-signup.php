...
?>
<p><?php esc_html_e( 'A new customer has signed up in Sunshine Photo Cart', 'sunshine-photo-cart' ); ?>: <?php echo $customer->get_name( __( 'No name given', 'sunshine-photo-cart' ) ); ?> (<?php echo esc_html( $customer->get_email() ); ?>)</p>
<p>
