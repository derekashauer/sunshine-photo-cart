<div id="sunshine-footer">
	<div id="sunshine-footer--content">
		<h2>Increase sales with <em>professional add-ons</em></h2>
		<p>With our amazing add-ons, you can grow your business and profits cover the cost with a single client!</p>
		<ul>
			<li>
			...
			<li>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
					<g transform="translate(-25.6 -25.6)">
					  <g transform="translate(25.6 25.6)">
						<path d="M37.6,25.6a12,12,0,1,0,12,12A12,12,0,0,0,37.6,25.6Zm0,6a4,4,0,0,1,4,4v1a1,1,0,0,1,1,1v4a1,1,0,0,1-1,1h-8a1,1,0,0,1-1-1v-4a1,1,0,0,1,1-1v-1A4,4,0,0,1,37.6,31.6Zm0,2a2,2,0,0,0-2,2v1h4v-1A2,2,0,0,0,37.6,33.6Z" transform="translate(-25.6 -25.6)" fill="#ffb600"/>
					  </g>
					</g>
				  </svg>
